...
export default function SignalsPage() {
  return (
    ...
    >
      <WidgetHost productId="menu-signals" partnerCode="DEMO" height={480} title="menu-signals — menu đầy đủ" />
      <WidgetHost productId="comp-signals" partnerCode="DEMO" height={320} title="comp-signals — khối gọn" />
      <ActionLog />
